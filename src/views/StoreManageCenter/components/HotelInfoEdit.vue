    ...
    <div>
        ...
        <el-form :model="form" label-width="auto" style="max-width: 300px">
            ...
            <el-form-item label="期間限定(非必填)">
                <el-row :gutter="50">
                    <el-col :span="16">
                        <el-date-picker v-model="form.date1" type="date" placeholder="開始日期" style="width: 100%" />
                    </el-col>
                    <el-col :span="2" class="text-center">
                        <span class="text-gray-500">-</span>
                    </el-col>
                    <el-col :span="16">
                        <el-date-picker v-model="form.date2" type="date" placeholder="結束日期" style="width: 100%" />
                    </el-col>
                </el-row>
            </el-form-item>
